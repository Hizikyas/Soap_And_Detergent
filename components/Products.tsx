      ...
      <section className={ `py-16 ${darkMode ? 'bg-gray-900' : 'bg-white' } transition-colors duration-300`} id="products">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid justify-center justify-items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  {products.map((product, index) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="relative group cursor-pointer rounded-xl overflow-hidden shadow-lg w-72"
